...
export default () => (
  <main>
    ...
    <section>
      ...
      <Example heading="Example #6" url="/headers-credentials" method="GET" />
      <Example heading="Example #7" url="/whitelist" method="GET" />
      <Example heading="Example #8" url="/regex" method="GET" />
      <p>(Example #8 should success only for requests from example.com or their subdomains.)</p>
    </section>
